...
let schemes = [
  "ReactiveFirebaseAuth",
  "ReactiveFirebaseDatabase",
  "ReactiveFirebaseStorage",
]

let staticLibs = [
  "Auth": "ReactiveFirebaseAuth",
  "Database": "ReactiveFirebaseDatabase",
  "Storage": "ReactiveFirebaseStorage",
]
...
let BuiltProductsDir = "ReactiveFirebaseFrameworks/"
...
//   "-workspace", "ReactiveFirebase.xcworkspace",
//   "-scheme",  "ReactiveFirebase",
//   "-sdk", "iphonesimulator",
...
zip("ReactiveFirebaseFrameworks", output: "ReactiveFirebaseFrameworks.zip")
